/*******************************************************************************
*                                                                              *
*              nova-control-node — runScript tests (RS)                        *
*                                                                              *
*******************************************************************************/

// tests runScript using a mock NovaController — no serial port required

import { describe, it, expect, vi } from 'vitest'
import { runScript, type NovaController, type ServoUpdate } from '../nova-control-node.js'
